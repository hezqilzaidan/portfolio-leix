<template>
  <main
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="10" height="10" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://static.vecteezy.com/system/resources/previews/027/245/520/non_2x/male-3d-avatar-free-png.png">
    </div>
  </main>
</template>
